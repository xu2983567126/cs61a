...
def distance(city_a, city_b):
    ...
    x1, y1 = get_location(city_a)
    x2, y2 = get_location(city_b)
...
def balanced(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    branches_of_t = branches(t)
    sum = sum_tree(branches_of_t[0])
    for branch in branches_of_t:
        if sum_tree(branch) != sum or not balanced(branch):
            return False
    return True
